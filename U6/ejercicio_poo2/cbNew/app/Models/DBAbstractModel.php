...
abstract class DBAbstractModel
{
    ...
    abstract protected function getEquipo($name,$db);
    abstract protected function insertEquipos($name,$db);
    abstract protected function updateEquipos($date,$db);
    abstract protected function deleteEquipos($id,$db);
    #Crear conexión a la base de datos.
    public function open_connection() //ponerlo public
    {
